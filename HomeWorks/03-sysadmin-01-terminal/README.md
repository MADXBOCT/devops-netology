...
обратил внимание что номера строк могут отличаться в зависимости от версии bash! отличаются в моих линуксах на virtual 
...
- обратиться к элементу массива по индексу, например 
